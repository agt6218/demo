window.onload = function() {
	$(document).ready(function() {
		...
		$("body").delegate("#new_game","click", function() {
			newGame();
		});
		$("body").delegate("#help","click", function() {
			$("#info").show();
		});
		$("body").delegate("#info_close","click", function() {
			$("#info").hide();
		});
	});
// ******
	...
	images = loadImages(
		["https://i.imgur.com/molURa1.png",
		"https://i.imgur.com/HibJePl.png",
		"https://i.imgur.com/X3y1Pjy.png",
		"https://i.imgur.com/YlAIINd.png",
		"https://i.imgur.com/xelw7Ol.png",
		"https://i.imgur.com/Me1wAd6.png",
		"https://i.imgur.com/lpdkt8s.png"]
	);
// ******
	...
	// Gui buttons
	var buttons = [ { x: 380, y: 240, width: 150, height: 50, text: "New Game"},
					{ x: 380, y: 300, width: 150, height: 50, text: "Show Moves"},
					{ x: 380, y: 360, width: 150, height: 50, text: "Enable AI Bot"}];
	...
	function render() {
		...
		drawCenterText("Score:",0,25,100);
		drawCenterText(score,100,25,70);
	...
	function drawTile(x, y, r, g, b) {
		...
		switch (rgb) {
			case "255128128":
				context.drawImage(images[0],x,y,50,60);
				break;
			case "128255128":
				context.drawImage(images[5],x,y,50,60);
				break;
			case "128128255":
				context.drawImage(images[2],x,y,50,60);
				break;
			case "255255128":
				context.drawImage(images[3],x,y,50,60);
				break;
			case "250180120":
				context.drawImage(images[4],x,y,50,60);
				break;
			case "255128255":
				context.drawImage(images[1],x,y,50,60);
				break;
			case "200200200":
				context.drawImage(images[6],x,y,50,60);
				break;
			case "25500":
				context.fillStyle = "transparent";
	...
	function renderClusters() {
		for (var i=0; i<clusters.length; i++) {
			...
			if (clusters[i].horizontal) {
				...
				context.fillStyle = "transparent";//"#00ff00";
				...
				context.fillStyle = "transparent";//"#0000ff";
